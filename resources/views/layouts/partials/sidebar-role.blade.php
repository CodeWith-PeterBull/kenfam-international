@php
    ...
    $permissionTools = collect([
        ...
        ['label' => 'Departures', 'route' => 'travel-tours.admin.departures.index', 'active' => ['travel-tours.admin.departures.*'], 'icon' => 'ti-calendar-event', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::VIEW_DEPARTURES, 'module' => 'travel-tours'],
        ['label' => 'Tour pricing', 'route' => 'travel-tours.admin.pricing.index', 'active' => ['travel-tours.admin.pricing.*'], 'icon' => 'ti-receipt-2', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::VIEW_PRICING, 'module' => 'travel-tours'],
        ['label' => 'Tour bookings', 'route' => 'travel-tours.admin.bookings.index', 'active' => ['travel-tours.admin.bookings.*'], 'icon' => 'ti-ticket', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::VIEW_BOOKINGS, 'module' => 'travel-tours'],
        ['label' => 'Tour inquiries', 'route' => 'travel-tours.admin.inquiries.index', 'active' => ['travel-tours.admin.inquiries.*'], 'icon' => 'ti-messages', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::VIEW_INQUIRIES, 'module' => 'travel-tours'],
        ['label' => 'Booking desk', 'route' => 'travel-tours.pob.terminal', 'active' => ['travel-tours.pob.terminal', 'travel-tours.pob.receipts.*'], 'icon' => 'ti-device-desktop', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::ACCESS_POB, 'module' => 'travel-tours'],
        ['label' => 'Booking registers', 'route' => 'travel-tours.pob.admin.registers.index', 'active' => ['travel-tours.pob.admin.registers.*'], 'icon' => 'ti-cash-register', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::MANAGE_SHIFTS, 'module' => 'travel-tours'],
        ['label' => 'Booking shifts', 'route' => 'travel-tours.pob.admin.shifts.index', 'active' => ['travel-tours.pob.admin.shifts.*'], 'icon' => 'ti-clock-dollar', 'permission' => \App\Modules\TravelTours\Support\TravelToursPermission::MANAGE_SHIFTS, 'module' => 'travel-tours'],
