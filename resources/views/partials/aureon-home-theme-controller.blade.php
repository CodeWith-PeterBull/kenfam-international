...
<aside class="offcanvas offcanvas-end theme-controller" tabindex="-1" id="themeController" data-theme-controller aria-labelledby="themeControllerTitle">
    <div class="offcanvas-header theme-controller-header">
        ...
        <button class="home-icon-button" type="button" data-bs-dismiss="offcanvas" aria-label="Close theme settings" title="Close"><i data-lucide="x" aria-hidden="true"></i></button>
    </div>
        ...
        <form data-theme-form>
            ...
            <fieldset class="theme-control-group">
                ...
                <div class="theme-palette-grid">
                    @foreach ([
                        ...
                        <label class="theme-palette-option" for="theme-palette-{{ $value }}"><span class="theme-palette-swatches" aria-hidden="true">@foreach ($swatches as $swatch)<i style="--swatch: {{ $swatch }}"></i>@endforeach</span><span>{{ $label }}</span></label>
                    @endforeach
                </div>
            </fieldset>
            <section class="theme-control-group">
                ...
                <div class="theme-custom-colors" data-theme-custom-fields>
                    <label for="theme-primary-color"><span>Primary</span><output data-theme-primary-output>#70233A</output></label><input type="color" id="theme-primary-color" value="#70233a" data-theme-primary>
                    <label for="theme-secondary-color"><span>Secondary</span><output data-theme-secondary-output>#28656B</output></label><input type="color" id="theme-secondary-color" value="#28656b" data-theme-secondary>
                </div>
            </section>
            <fieldset class="theme-control-group">
