<style>
    ...
    * { box-sizing: border-box; }
    ...
    .report-header { padding-bottom: 10px; margin-bottom: 14px; border-bottom: 2px solid #70233a; text-align: center; }
    ...
    .institution-contact { margin-top: 6px; color: #70233a; font-size: 8px; }
    ...
    .metric strong { display: block; color: #70233a; font-size: 15px; }
    ...
    th { color: #fff; background: #70233a; font-weight: 700; }
