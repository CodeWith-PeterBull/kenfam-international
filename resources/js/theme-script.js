...
document
    .querySelector("html")
    .setAttribute("data-layout", localStorage.getItem("layout") || "default");
document
    .querySelector("html")
...
<div class="sidebar-contact ">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between bg-dark">
        <div>
            <h3 class="mb-1 text-white">APP SETTINGS</h3>
            <p class="text-white">Customize your application settings.</p>
        </div>
    ...
    <div class="themecard-body offcanvas-body">
        ...
        <div class="p-3 pt-0">
            <div class="row gx-3">
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-primary w-100" data-bs-dismiss="offcanvas"><i class="ti ti-shopping-cart-plus me-1"></i>Done!</a>
                </div>
            </div>
        </div>    
    </div>
