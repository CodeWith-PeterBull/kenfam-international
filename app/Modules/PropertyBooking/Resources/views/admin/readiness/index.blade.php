...
@section('content')
    <main id="property-booking-readiness" class="property-booking-admin" data-property-booking-admin>
        <div class="page-header">
            <div class="page-title">
                <h4>Unit readiness</h4>
                <h6>Housekeeping, maintenance, occupancy context, and release-to-sell workflow</h6>
            </div>
            <div class="page-btn">
        ...
        <livewire:property-booking.admin.unit-readiness-manager />
    </main>
@endsection
