...
<aside class="offcanvas offcanvas-end theme-controller" tabindex="-1" id="themeController" data-theme-controller aria-labelledby="themeControllerTitle">
    <div class="offcanvas-header theme-controller-header">
        <div>
            <p class="theme-controller-kicker">Appearance</p>
            <h2 id="themeControllerTitle">Theme settings</h2>
        </div>
        <button class="travel-icon-button" type="button" data-bs-dismiss="offcanvas" aria-label="Close theme settings" title="Close"><i data-lucide="x" aria-hidden="true"></i></button>
    </div>
        ...
        <form data-theme-form>
            <fieldset class="theme-control-group">
                ...
                <div class="theme-segmented theme-segmented-two">
                    <input class="visually-hidden" type="radio" name="theme-mode" id="theme-mode-light" value="light">
                    <label for="theme-mode-light"><i data-lucide="sun" aria-hidden="true"></i>Light</label>
                    <input class="visually-hidden" type="radio" name="theme-mode" id="theme-mode-dark" value="dark">
                    <label for="theme-mode-dark"><i data-lucide="moon" aria-hidden="true"></i>Dark</label>
                </div>
            </fieldset>
            <fieldset class="theme-control-group">
            ...
            <section class="theme-control-group">
                <div class="theme-control-heading">
                    <label for="theme-custom-toggle">Custom colors</label>
            ...
            <fieldset class="theme-control-group">
                ...
                <div class="theme-select-grid">
                    <label for="theme-font-body">Body font</label>
                    <select id="theme-font-body" name="theme-font-body"><option value="poppins">Poppins</option><option value="jost">Jost</option><option value="montserrat">Montserrat</option><option value="system">System UI</option></select>
                    <label for="theme-font-heading">Heading font</label>
                    <select id="theme-font-heading" name="theme-font-heading"><option value="poppins">Poppins</option><option value="jost">Jost</option><option value="montserrat">Montserrat</option><option value="system">System UI</option></select>
                </div>
            </fieldset>
            <fieldset class="theme-control-group">
