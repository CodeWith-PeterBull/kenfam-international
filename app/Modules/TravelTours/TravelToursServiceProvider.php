...
use App\Modules\TravelTours\Policies\PricingPolicy;
...
final class TravelToursServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(TourRatePlan::class, PricingPolicy::class);
        Gate::policy(PricingRule::class, PricingPolicy::class);
        Gate::policy(Promotion::class, PricingPolicy::class);
        ...
        Livewire::component('travel-tours.admin.rate-plan-manager', RatePlanManager::class);
        Livewire::component('travel-tours.admin.pricing-rule-manager', PricingRuleManager::class);
